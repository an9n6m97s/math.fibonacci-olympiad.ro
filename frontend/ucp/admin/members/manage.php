...
<div id="members" data-list='{"valueNames":["fullName","role","email","phone_number","dob","tshirt","emergency_contact"],"page":10,"pagination":true}'>
    <div class="row align-items-center justify-content-between g-3 mb-4">
        ...
        <div class="col-auto">
            <div class="d-flex align-items-center"><a class="btn btn-primary" href="/ucp/admin/members/create"><span class="fas fa-plus me-2"></span>Add member</a></div>
        </div>
    </div>
                    ...
                    <?php foreach ($members as $member): ?>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="customer align-middle white-space-nowrap">
                                <a class="d-flex align-items-center text-body text-hover-1000" href="/ucp/admin/members/edit?id=<?= $member['id'] ?>">
                            ...
                            <td class="edit_member align-middle white-space-nowrap text-body-tertiary"><a href="/ucp/admin/members/edit?id=<?= $member['id'] ?>"><span data-feather="edit-3"></span> Edit member</a></td>
                            <td class="delete_member align-middle white-space-nowrap text-body-tertiary"><a href="#!" onclick="adminDeleteMember(<?= $team['id'] ?>, <?= $member['id'] ?>)"><span data-feather="trash-2"></span> Delete member</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
