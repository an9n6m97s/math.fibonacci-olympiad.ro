                        ...
                        <div class="col-auto bg-body-highlight dark__bg-gray-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                            ...
                            <div class="position-relative px-4 px-lg-7 pt-7 pb-7 pb-sm-5 text-center text-md-start pb-lg-7">
                                ...
                                <p class="text-body-tertiary">
                                    Enter your registered email address to receive a password reset link for your Fibonacci Romania 2026 account.
                                </p>
                            ...
                            <div class="position-relative z-n1 mb-6 d-none d-md-block text-center mt-md-5"><img class="auth-title-box-img d-dark-none" src="/assets/ucp//img/spot-illustrations/auth.png" alt="" /><img class="auth-title-box-img d-light-none" src="/assets/ucp//img/spot-illustrations/auth-dark.png" alt="" /></div>
                        </div>
                        <div class="col mx-auto">
                            <div class="auth-form-box">
                                <div class="text-center"><a class="d-flex flex-center text-decoration-none mb-4" href="/">
                                    ...
                                    <form class="d-flex align-items-center mb-5" id="forgot-email">
                                        <input class="form-control flex-1" id="email" type="email" placeholder="Email" id="forgot-email" />
                                        <button class="btn btn-primary ms-2">Send<span class="fas fa-chevron-right ms-2"></span></button>
                                    </form>
                                    <a class="fs-9 fw-bold" href="/contact">Still having problems?</a>
                                </div>
                            </div>
                        </div>
                    </div>
