             ...
             <div class="card h-100">
                 <div class="card-body">
                     ...
                     <div class="d-flex gap-2 flex-wrap">
                         <a class="btn btn-danger" href="/ucp/info/timeline">View Timeline</a>
                         <a class="btn btn-danger" href="/ucp/info/travel">Travel & Access</a>
                         <a class="btn btn-danger" href="/ucp/info/accommodation">Accommodation</a>
                     </div>
                 </div>
             </div>
         </div>
         <div class="col-12 col-lg-4">
             <div class="card h-100">
                 <div class="card-body">
                     ...
                     <a class="btn btn-danger" href="/ucp/info/eligibility">Eligibility & Categories</a>
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="col-12 col-md-6 col-xl-4">
             <div class="card h-100">
                 <div class="card-body">
                     ...
                     <a class="btn btn-danger" href="/ucp/info/travel">Access details</a>
                 </div>
             </div>
         </div>
         <div class="col-12 col-md-6 col-xl-4">
             <div class="card h-100">
                 <div class="card-body">
                     ...
                     <a class="btn btn-danger" href="/ucp/info/faq">What to bring</a>
                 </div>
             </div>
         </div>
         ...
         <div class="col-12 col-sm-6 col-xl-4">
             <div class="card h-100">
                 <div class="card-body">
                     ...
                     <a class="btn btn-danger" href="/ucp/info/deadline">All dates</a>
                 </div>
             </div>
         </div>
         <div class="col-12 col-xl-4">
             <div class="card h-100">
                 <div class="card-body">
                     ...
                     <p class="mb-3">
                         ...
                         page available at <a href="/ucp/info/travel">/info/travel</a>.
                     </p>
